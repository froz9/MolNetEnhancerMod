...
# MolNetEnhancerMod
MolNetEnhancerMod is an alternative to the non-working MolNetEnhancer. It uses a modified approximation to retrieve SMILES classification, supporting both [NPClassifier](https://pubs.acs.org/doi/10.1021/acs.jnatprod.1c00399) and [ClassyFire](https://link.springer.com/article/10.1186/s13321-016-0174-y) for robust molecular networking and detailed structural insights in metabolomics data.
